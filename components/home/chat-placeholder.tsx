...
const ChatPlaceHolder = () => {
	return (
		<div className='w-full h-full bg-gray-secondary flex flex-col items-center justify-center py-10'> {/* Full width and height */}
			<div className='flex flex-col items-center w-full justify-center py-10 gap-4'>
				...
				<p className='text-3xl font-extralight text-center mt-5 mb-2'>Download WhatsApp for Windows</p>
				<p className='w-1/2 text-center align-center justify-center text-gray-primary text-sm text-muted-foreground'>
