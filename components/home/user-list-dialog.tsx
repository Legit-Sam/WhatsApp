...
const UserListDialog = () => {
  ...
  const handleCreateConversation = async () => {
    ...
    if (!me) {
      toast.error("Unable to retrieve your user details.");
      return;
    }
    ...
    try {
      ...
      const conversationName = isGroup ? groupName : user?.name || user?.email.split("@")[0] || "";

      setSelectedConversation({
        _id: conversationId,
        participants: selectedUsers,
        isGroup,
        image: isGroup ? renderedImage : user?.image || "",
